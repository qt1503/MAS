...
from mint.testing.prompts.few_shot_PoT import few_shot_tatqa, few_shot_gsm8k, few_shot_tabmwp
...
class ProgramOfThoughtsPrompt:
    ...
    def solve(self, question: str, context: Optional[str], show_code: bool,select_fewshot:str):
        context_str = f"# Context:\n{context}\n" 
        pot_messages = [
        SystemMessage("You will write python program to solve math problems."),
        HumanMessage(content=f"""
        {select_fewshot}
        # Include a final answer as a single number, no units or symbols and no text.
